      ...
      <div className="ios-card max-h-[78vh] w-full overflow-hidden rounded-t-[32px] px-5 pb-6 pt-4 lg:max-h-[82vh] lg:max-w-[640px] lg:rounded-[28px]">
        ...
        <div className="ios-panel rounded-[24px] p-3">
          ...
          <div className="mt-2 flex items-center justify-between">
            <span className="text-[12px] text-ink/45">{isSubmitting ? '正在发送评论...' : '写下你的想法'}</span>
            <button
              className="ios-pill inline-flex items-center gap-2 rounded-[14px] bg-accent px-4 py-2 text-[13px] font-semibold text-white disabled:opacity-60"
